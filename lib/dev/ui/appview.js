...
var AppView = function(attrs) {
  ...
  this.app.on('runner-connected', this.runnerConnected.bind(this));

  this.app.on('runner-disconnected', this.runnerDisconnected.bind(this))
...
AppView.prototype.renderRunnerTabs = function() {
  this.runners.forEach(function (runner) {
    runner.render(this.runners.length);
  }, this);
  this.screen.render();
}
...
AppView.prototype.runnerConnected = function(runner) {
  log.info('runnerConnected');
  this.runners.push(
    new RunnerTab(runner, this.layout, this.runners.length)
  );
  this.renderRunnerTabs();
}

AppView.prototype.runnerDisconnected = function() {
...
AppView.prototype.cleanup = function(cb) {
  ...
  this.app.removeListener('runner-connected', this.runnerConnected.bind(this));
  this.app.removeListener('runner-connected', this.runnerConnected.bind(this));
  cb();
}

AppView.prototype.clearErrorPopupMessage = function() {
}
